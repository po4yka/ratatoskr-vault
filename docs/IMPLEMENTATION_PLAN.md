...
1. Scaffold service, typed config, telemetry, errors, health, and `git_vault` schema.
...
Definition of Done: one desired target is restored from an independently verified artifact; hostile execution, corruption, interruption, retention, migrations, and workspace integration pass. Deferred: incremental bundle chains and broad GitHub issue/release archival until needed.
